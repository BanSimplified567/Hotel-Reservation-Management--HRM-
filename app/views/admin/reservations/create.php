          ...
          <div class="col-md-6">
              ...
              <select class="form-control" id="user_id" name="user_id" required>
                ...
                <?php foreach ($customers as $customer): ?>
                  <option value="<?php echo $customer['id']; ?>"
                    <?php echo ($old['user_id'] ?? '') == $customer['id'] ? 'selected' : ''; ?>>
              ...
              <select class="form-control" id="room_id" name="room_id" required>
                ...
                <?php foreach ($rooms as $room): ?>
                  <option value="<?php echo $room['id']; ?>"
                    ...
                    <?php echo ($old['room_id'] ?? '') == $room['id'] ? 'selected' : ''; ?>>
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="guests" name="guests" min="1"
                value="<?php echo htmlspecialchars($old['guests'] ?? 1); ?>" required>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="status" name="status" required>
                ...
                <option value="confirmed" <?php echo ($old['status'] ?? '') == 'confirmed' ? 'selected' : ''; ?>>Confirmed</option>
                <option value="checked_in" <?php echo ($old['status'] ?? '') == 'checked_in' ? 'selected' : ''; ?>>Checked-in</option>
              </select>
            </div>
          </div>
        </div>
