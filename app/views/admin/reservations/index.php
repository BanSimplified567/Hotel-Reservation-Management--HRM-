        ...
        <tbody>
            ...
            <?php else: ?>
                ...
                <tr>
                        ...
                        <span style="
                            ...
                            background-color: <?php
                                switch($reservation['status']) {
                                    ...
                                    case 'checked_in': echo '#28a745';
                                    case 'completed': echo '#6c757d';
                    ...
                    <td>
                        <a href="index.php?action=admin/reservations/view&id=<?php echo $reservation['id']; ?>">View</a>
                        <a href="index.php?action=admin/reservations/edit&id=<?php echo $reservation['id']; ?>">Edit</a>
