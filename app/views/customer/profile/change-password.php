...
<body>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6">
                        <div class="card password-card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="index.php?index.php?action=profile&sub_action=change-password" id="passwordForm" class="needs-validation" novalidate>
                                    <!-- Current Password -->
                                    <div class="mb-4">
    ...
    <script>
        ...
        function checkPasswordStrength() {
            ...
            const allValid = hasLength && hasUpper && hasNumber && passwordsMatch && password !== '';
